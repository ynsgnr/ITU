                    ...
                    loff_t *f_pos)
{
  ...
  out:
    ...
    loff_t pos = 0;
    struct file *file;
	char *fp="/home/itucs/Desktop/code/test234.txt";
	file = filp_open(fp, O_WRONLY|O_CREAT, 0644);
    vfs_write(file, dev->data[s_pos]+q_pos, count, &pos);
